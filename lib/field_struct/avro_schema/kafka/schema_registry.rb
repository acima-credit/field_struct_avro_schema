...
# https://github.com/dasch/avro_turf/blob/master/lib/avro_turf/confluent_schema_registry.rb
#
    ...
    module Kafka
      class SchemaRegistry
        ...
        def check(subject, schema)
          response = post "/subjects/#{subject}",
                          expects: [200, 404],
        ...
        def request(path, **options)
          options = { expects: 200, path: path }.merge! options
